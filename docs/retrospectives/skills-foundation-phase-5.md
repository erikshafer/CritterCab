...
- Skills reconciled: 13 / 39
- Total lines trimmed: ~461
- Direct-equivalent (deduplicated): 10
...
- Upstream-contribution candidates: 16 (14 footgun-style additions + 1 entire-skill-creation covering both gRPC skills (Active, Erik's roadmap) + 1 entire-skill-creation for sagas (Observed gap, no active author))
...
- Forward-looking placeholders removed: 7 (Skills 4, 5, 8, 9, 11, 12, 13 — pre-Phase-5 Cab pattern of placeholdering not-yet-published ai-skills counterparts; same nonexistent `marten-event-sourcing-fundamentals` referenced 4 times across Skills 9, 11, 12, 13)

...
| Onboarding | Identity → Onboarding (edge #3); Onboarding → Driver Profile (edge #6). | Lifecycle BC; conversion of authenticated driver into Driver-Profile-active driver. |

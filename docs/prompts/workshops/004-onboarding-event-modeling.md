...
| **FCRA two-phase notice** | `PreAdverseActionNoticeIssued`, `DisputeWindowExpired` (Bruun temporal automation; W003 OQ-6), `FinalAdverseActionNoticeIssued` |
